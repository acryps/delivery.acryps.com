	...
	updatePosition() {
		if (this.target) {
			...
			const angle = Math.atan2(
				(this.parent.map.position.latitude - this.target.latitude) * this.parent.map.scale.x,
				(this.parent.map.position.longitude - this.target.longitude) * this.parent.map.scale.y
